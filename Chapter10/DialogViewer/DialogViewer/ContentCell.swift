...
class ContentCell: UICollectionViewCell {
    ...
    var text:String!{
        ...
        set(newText){
            ...
            let textSize=self.dynamicType.sizeFontContentString(newText, fontMaxWidth: maxWidth)
    ...
    class func sizeFontContentString(s:String,fontMaxWidth maxWidth:CGFloat)->CGSize{
